...
static bool cb_asm_offset_segment_size(void *user, void *data) {
	RCore *core = (RCore *) user;
	RConfigNode *node = (RConfigNode *) data;
...
R_API int r_core_config_init(RCore *core) {
	...
	SETICB ("anal.cs", 0, (RConfigCallback)&cb_anal_cs, "set the value for the x86-16 CS segment register (see asm.offset.segment and asm.offset.segment.size)");
	...
	SETICB ("asm.offset.segment.size", 4, &cb_asm_offset_segment_size, "segment granularity in bits (x86-16)");
